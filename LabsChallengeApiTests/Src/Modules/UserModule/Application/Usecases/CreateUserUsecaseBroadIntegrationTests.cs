...
[TestClass]
public class CreateUserUsecaseBroadIntegrationTests
{
    ...
    public void Setup()
    {
        ...
        _createUserUsecase = new CreateUserUsecase(_mockUserRepository.Object, _mockUserDAO.Object, _mockPasswordHasher.Object, _queueService);
