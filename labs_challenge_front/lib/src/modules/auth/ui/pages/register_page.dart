...
import 'package:labs_challenge_front/src/shared/widgets/app_back_button_bar.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              AppTextFormField(
                ...
                validator: (value) => FormValidators.isRequired(value, fieldName: 'Nome'),
              ),
              ...
              AppTextFormField(
                ...
                obscureText: true,
                autovalidateMode: AutovalidateMode.onUserInteraction,
                validator: (value) => FormValidators.passwordStrengthValidator(value),
                onChanged: (value) {
                  setState(() {
                    passwordStrengthText = FormValidators.passwordStrengthLevel(value);
                  });
                },
              ),
